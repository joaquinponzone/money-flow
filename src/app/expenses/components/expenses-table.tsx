          ...
          <TabsContent value="monthly">
            ...
            <div className="hidden md:block">
              <Table>
                <TableHeader>
                  <TableRow>
                    <TableHead className="font-bold text-black text-lg">Title</TableHead>
                    <TableHead className="font-bold text-black text-lg">Amount</TableHead>
                    <TableHead className="font-bold text-black text-lg">Category</TableHead>
                    <TableHead className="font-bold text-black text-lg">Status</TableHead>
                    <TableHead className="font-bold text-black text-lg">Due/Paid Date</TableHead>
                    <TableHead className="text-right font-bold text-black text-lg">Actions</TableHead>
                  </TableRow>
                </TableHeader>
                <TableBody>
                  {currentMonthExpenses.map((expense) => {
